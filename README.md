# cnt4713-project-2
Python DNS iterative lookup client using sockets
...
Send a DNS query to a root DNS server

The root server returns NS records in the Authority section

The Additional Information section contains IP addresses of those servers

The program chooses one of those IPs

A new query is sent to that DNS server

The process continues until the final A record is returned
...
README.txt – Member names and IDs,
